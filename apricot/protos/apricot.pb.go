...
type ComponentRuntimeRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ComponentRuntimeRequest) Reset() {
	*x = ComponentRuntimeRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ComponentRuntimeRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ComponentRuntimeRequest) ProtoMessage() {}

func (x *ComponentRuntimeRequest) ProtoReflect() protoreflect.Message {
	mi := &file_protos_apricot_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ComponentRuntimeRequest.ProtoReflect.Descriptor instead.
func (*ComponentRuntimeRequest) Descriptor() ([]byte, []int) {
	return file_protos_apricot_proto_rawDescGZIP(), []int{3}
}

func (x *ComponentRuntimeRequest) GetComponent() string {
	if x != nil {
		return x.Component
	}
	return ""
...
func (x *ComponentRuntimeRequest) GetEntry() string {
	if x != nil {
		return x.Entry
	}
	return ""
...
var file_protos_apricot_proto_rawDesc = []byte{
	...
	0x22, 0x4d, 0x0a, 0x17, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x63,
	0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6e, 0x74,
	0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22,
	0x2d, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x74, 0x68, 0x2a, 0x38, 0x0a, 0x07, 0x52, 0x75, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x08, 0x0a,
	...
	0x09, 0x54, 0x45, 0x43, 0x48, 0x4e, 0x49, 0x43, 0x41, 0x4c, 0x10, 0x03, 0x32, 0xac, 0x03, 0x0a,
	...
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x4d, 0x61, 0x70, 0x22, 0x00, 0x12, 0x54, 0x0a, 0x19,
	...
	0x22, 0x00, 0x12, 0x55, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65,
	0x6e, 0x74, 0x52, 0x75, 0x6e, 0x74, 0x69, 0x6d, 0x65, 0x12, 0x20, 0x2e, 0x61, 0x70, 0x72, 0x69,
	0x63, 0x6f, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52, 0x75, 0x6e,
	0x74, 0x69, 0x6d, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1a, 0x2e, 0x61, 0x70,
	0x72, 0x69, 0x63, 0x6f, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x0f, 0x52, 0x61, 0x77,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x36, 0x0a, 0x22, 0x63,
...
var file_protos_apricot_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_protos_apricot_proto_goTypes = []interface{}{
	...
	(*ComponentRuntimeRequest)(nil), // 4: apricot.ComponentRuntimeRequest
	(*ComponentResponse)(nil),       // 5: apricot.ComponentResponse
	(*RunNumberResponse)(nil),       // 6: apricot.RunNumberResponse
	(*StringMap)(nil),               // 7: apricot.StringMap
	(*RawGetRecursiveRequest)(nil),  // 8: apricot.RawGetRecursiveRequest
	nil,                             // 9: apricot.ComponentRequest.VarStackEntry
	nil,                             // 10: apricot.StringMap.StringMapEntry
}
var file_protos_apricot_proto_depIdxs = []int32{
	...
	9,  // 2: apricot.ComponentRequest.varStack:type_name -> apricot.ComponentRequest.VarStackEntry
	10, // 3: apricot.StringMap.stringMap:type_name -> apricot.StringMap.StringMapEntry
	...
	4,  // 8: apricot.Apricot.GetComponentRuntime:input_type -> apricot.ComponentRuntimeRequest
	8,  // 9: apricot.Apricot.RawGetRecursive:input_type -> apricot.RawGetRecursiveRequest
	6,  // 10: apricot.Apricot.NewRunNumber:output_type -> apricot.RunNumberResponse
	7,  // 11: apricot.Apricot.GetDefaults:output_type -> apricot.StringMap
	7,  // 12: apricot.Apricot.GetVars:output_type -> apricot.StringMap
	5,  // 13: apricot.Apricot.GetComponentConfiguration:output_type -> apricot.ComponentResponse
	5,  // 14: apricot.Apricot.GetComponentRuntime:output_type -> apricot.ComponentResponse
	5,  // 15: apricot.Apricot.RawGetRecursive:output_type -> apricot.ComponentResponse
...
func file_protos_apricot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_apricot_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ComponentRuntimeRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
...
type ApricotClient interface {
	...
	GetComponentRuntime(ctx context.Context, in *ComponentRuntimeRequest, opts ...grpc.CallOption) (*ComponentResponse, error)
...
func (c *apricotClient) GetComponentRuntime(ctx context.Context, in *ComponentRuntimeRequest, opts ...grpc.CallOption) (*ComponentResponse, error) {
	out := new(ComponentResponse)
	err := c.cc.Invoke(ctx, "/apricot.Apricot/GetComponentRuntime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApricotServer interface {
	...
	GetComponentRuntime(context.Context, *ComponentRuntimeRequest) (*ComponentResponse, error)
...
func (*UnimplementedApricotServer) GetComponentRuntime(context.Context, *ComponentRuntimeRequest) (*ComponentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetComponentRuntime not implemented")
}
...
func _Apricot_GetComponentRuntime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ComponentRuntimeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApricotServer).GetComponentRuntime(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/apricot.Apricot/GetComponentRuntime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApricotServer).GetComponentRuntime(ctx, req.(*ComponentRuntimeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Apricot_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetComponentRuntime",
			Handler:    _Apricot_GetComponentRuntime_Handler,
		},
		{
