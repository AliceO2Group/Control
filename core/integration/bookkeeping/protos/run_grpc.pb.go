...
func (c *runServiceClient) Get(ctx context.Context, in *RunFetchRequest, opts ...grpc.CallOption) (*RunWithRelations, error) {
	...
	err := c.cc.Invoke(ctx, "/o2.bookkeeping.RunService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runServiceClient) Create(ctx context.Context, in *RunCreationRequest, opts ...grpc.CallOption) (*Run, error) {
	out := new(Run)
	err := c.cc.Invoke(ctx, "/o2.bookkeeping.RunService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *runServiceClient) Update(ctx context.Context, in *RunUpdateRequest, opts ...grpc.CallOption) (*Run, error) {
	out := new(Run)
	err := c.cc.Invoke(ctx, "/o2.bookkeeping.RunService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RunService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/o2.bookkeeping.RunService/Get",
	}
...
func _RunService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/o2.bookkeeping.RunService/Create",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _RunService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/o2.bookkeeping.RunService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
