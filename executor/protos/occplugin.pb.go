...
func (StateChangeTrigger) EnumDescriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{0} }
...
func (StateType) EnumDescriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{1} }
...
func (*StateStreamRequest) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{0} }
...
func (*StateStreamReply) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{1} }
...
func (*GetStateRequest) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{2} }
...
func (*GetStateReply) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{3} }
...
func (*ConfigEntry) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{4} }
...
func (*TransitionRequest) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{5} }
...
func (*TransitionReply) Descriptor() ([]byte, []int) { return fileDescriptorOccPlugin, []int{6} }
...
func init() { proto.RegisterFile("protos/OccPlugin.proto", fileDescriptorOccPlugin) }

var fileDescriptorOccPlugin = []byte{
