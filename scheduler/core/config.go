...
func (cfg *Config) AddFlags(fs *flag.FlagSet) {
	...
	fs.StringVar(&cfg.executor, "executor", cfg.executor, "Full path to executor binary on Mesos agents")
	...
	fs.StringVar(&cfg.server.address, "server.address", cfg.server.address, "IP of metrics server")
